...
class _$NotificationModelImpl implements _NotificationModel {
  ...
  @override
  String toString() {
    return 'NotificationModel(id: $id, type: $type, title: $title, description: $description, eventAt: $eventAt, entityType: $entityType, entityId: $entityId, data: $data)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, type, title, description,
      eventAt, entityType, entityId, data);
