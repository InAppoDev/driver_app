...
import 'package:tms_driver/data/models/dispatch/waipoint/waipoint_summary_model.dart';
...
class DispatchListModel with _$DispatchListModel {
  const factory DispatchListModel({
    ...
    @JsonKey(name: 'waypoints') required List<WaipointSummaryModel> waypoints,
  }) = _DispatchListModel;
